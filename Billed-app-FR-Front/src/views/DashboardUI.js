      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          <div class='status-bills-header'>
            <h2> En attente (${filteredBills(data && data.bills, "pending").length}) </h2>
          ...
          <div class='status-bills-container' id='status-bills-container1'>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              <h2> Validé (${filteredBills(data && data.bills, "accepted").length}) </h2>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              <h2> Refusé (${filteredBills(data && data.bills, "refused").length}) </h2>
